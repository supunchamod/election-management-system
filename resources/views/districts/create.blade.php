                    ...
                    <div class="row">
                        <div class="col-md-8 col-lg-8">
                            <div class="card">
                                ...
                                <form class="row g-3 needs-validation" method="POST" action="{{ route('districts.store') }}" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="col-md-6">
                <label for="validationCustom03" class="form-label">District Name</label>
                <input type="text" name="district_name" class="form-control" id="validationCustom03" required>
