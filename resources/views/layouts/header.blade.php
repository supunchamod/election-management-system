                ...
                <div class="startbar-collapse" id="startbarCollapse" data-simplebar>
                    <div class="d-flex align-items-start flex-column w-100">
                        ...
                        <ul class="navbar-nav mb-auto w-100">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#sidebarApplications1" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarApplications1">
                                    <i class="iconoir-view-grid menu-icon"></i>
                                    <span>Party</span>
                                </a>
                                <div class="collapse " id="sidebarApplications1">
                                    <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a href="/add-party" class="nav-link ">Add Party</a>
                                    </li><!--end nav-item-->
                                    <li class="nav-item">
                                        <a href="{{ route('parties.index') }}" class="nav-link ">View Party</a>
                                    </li><!--end nav-item-->                                                              
                                    </ul><!--end nav-->
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#sidebarAdvancedUI" data-bs-toggle="collapse" role="button"
                                    ...
                                    <span>Memeber</span><span class="badge rounded text-success bg-success-subtle ms-1">New</span>
                                </a>
                                <div class="collapse " id="sidebarAdvancedUI">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a href="{{ route('members.create') }}" class="nav-link ">Add Memeber</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a href="{{ route('members.index') }}" class="nav-link ">View Memeber</a>
                                        </li><!--end nav-item-->                                
                                    </ul><!--end nav-->
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse " id="sidebarForms">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a href="{{ route('districts.create') }}" class="nav-link ">Add District</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a href="{{ route('districts.index') }}" class="nav-link ">View District</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a href="{{ route('divisions.create') }}" class="nav-link ">Add Division</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a href="{{ route('divisions.index') }}" class="nav-link ">Add Division</a>
                                        </li><!--end nav-item-->
                                    </ul><!--end nav-->
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse " id="sidebarApplications">
                                    ...
                                    @foreach($districts as $district)
                                        <li class="nav-item">
                                            <a class="nav-link" href="#sidebarAnalytics{{ $district->id }}" data-bs-toggle="collapse" role="button"
                                                aria-expanded="false" aria-controls="sidebarAnalytics">                                        
                                                <span> {{ $district->district_name }}</span>
                                            </a>
                                            <div class="collapse " id="sidebarAnalytics{{ $district->id }}">
                                                <ul class="nav flex-column">
                                                @foreach($district->divisions as $division)
                                                    <li class="nav-item">
                                                        <a href="{{ route('division.results', $division->id) }}" class="nav-link "> {{ $division->division_name }}</a>
                                                    </li><!--end nav-item-->
                                                @endforeach                                                                           
                                                </ul><!--end nav-->
                                            </div>
