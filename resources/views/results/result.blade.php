                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        <div class="col">                      
                                            <h2 class="card-title" style="font-size: 25px;font-weight: 700;"> Result for Postal Votes - {{ $result->division->division_name }}</h2>                      
                                        </div><!--end col-->
                                        <div class="col-auto">            
                                        </div><!--end col-->
                                    </div>  <!--end row-->                                  
                                                            ...
                                                            <div class="flex-grow-1 text-truncate"> 
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <div class="progress bg-primary-subtle w-100" style="height:5px;" role="progressbar" aria-label="Success example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                                                        <div class="progress-bar" style="width: {{ $memberVote->votes_percentage }}%; background-color: {{ $memberVote->member->color_code }};"></div>
                                                                    </div> 
                                                                    <small class="flex-shrink-1 ms-1">{{ $memberVote->votes_percentage }}%</small>
                                                                    <span class="text-body ps-2 align-self-center text-end">{{ $memberVote->votes }}</span>
                        ...
                        <div class="row">
                                <div class="col-lg-12"> <!-- Change col-md-4 to col-md-3 for 4 cards per row -->
                                    <div class="summery"> <!-- h-100 to make cards the same height -->
                                        <div class="col-lg-3">                                            
                                            <p class="card-text">Registered Electors: <strong>{{ $result->number_of_registered_electors }}</strong></p>
                                        ...
                                        <div class="col-lg-3">                                            
                                            <p class="card-text">Votes Polled: <strong>{{ $result->number_of_votes_polled }}</strong></p>
                                            <div class="progress mb-3">
                                        ...
                                        <div class="col-lg-3">                                            
                                            <p class="card-text">Rejected Votes: <strong>{{ $result->number_of_rejected_votes }}</strong></p>
                                            <div class="progress mb-3">
